package tk.nomis_tech.ppimapbuilder.ui.credits;
...
import tk.nomis_tech.ppimapbuilder.ui.util.EscapeCloseListener;
import tk.nomis_tech.ppimapbuilder.ui.util.JHyperlinkLabel;
import tk.nomis_tech.ppimapbuilder.ui.util.LogoIcon;
import tk.nomis_tech.ppimapbuilder.ui.util.PicardLabIcon;
...
public class CreditFrame extends JFrame {
	...
	public CreditFrame(OpenBrowser openBrowser) {
		...
		getContentPane().add(lblGuillaumeCornut, "cell 0 9,alignx center");

		// Pierre Dupuis
		JLabel lblPierreDupuis = new JLabel("Pierre Dupuis");
		getContentPane().add(lblPierreDupuis, "cell 2 9,alignx center");

		// Kévin Gravouil
		JLabel lblKvinGravouil = new JLabel("Kévin Gravouil");
		getContentPane().add(lblKvinGravouil, "cell 0 10,alignx center");
		
		// Armelle Kieffer
		JLabel lblArmelleKieffer = new JLabel("Armelle Kieffer");
		getContentPane().add(lblArmelleKieffer, "cell 2 10,alignx center");
