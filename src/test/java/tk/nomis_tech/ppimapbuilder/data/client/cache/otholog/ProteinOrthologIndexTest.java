...
public class ProteinOrthologIndexTest {

	static ProteinOrthologIndex indexEmpty;
	static ProteinOrthologIndex indexExample;
	static ProteinOrthologIndex indexBig;
	...
	public static void before() throws IOException {
		...
		indexEmpty = new ProteinOrthologIndex("indexEmpty");
		indexEmpty.save();
		//System.out.println("Empty index: " + indexEmpty);

		indexExample = new ProteinOrthologIndex("indexExample") {{
			addProtein(Q9ESJ7);
			addProtein(Q78IQ7);
			addProtein(Q01815);
			addProtein(Q99KG5);
		...
		indexBig = new ProteinOrthologIndex("indexBig") {{
			int i = 0;
			for (; i <= 10000; i++) {
	...
	public void testSaveLoadIndex() throws IOException {
		//Manual saving
		ProteinOrthologIndex index = new ProteinOrthologIndex("indexSaveTest");
		int expected = index.addProtein(P04040);
		index.save();

		//Automatic loading from file
		ProteinOrthologIndex index2 = new ProteinOrthologIndex("indexSaveTest");
