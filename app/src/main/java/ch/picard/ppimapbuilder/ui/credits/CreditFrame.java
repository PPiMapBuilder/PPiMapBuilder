...
public class CreditFrame extends JFrame {
	...
	public CreditFrame(OpenBrowser openBrowser) {
		...
		lblEmail.setText("<pablo.echeverria@unige.ch>");
		lblEmail.setToolTipText("Send an email");
		lblEmail.makeClickable();
		try {
			lblEmail.setUri(new URI("mailto:pablo.echeverria@unige.ch"));
		...
		// Project leaders
		JLabel lblProjectLeaders = new JLabel("Project leaders:");
		lblProjectLeaders.setFont(new Font("Lucida Grande", Font.BOLD, 12));
		container.add(lblProjectLeaders, "cell 0 10 3 0,alignx center");

		// Pierre Dupuis
		JLabel lblPierreDupuis = new JLabel("Pierre Dupuis");
		container.add(lblPierreDupuis, "cell 0 11,alignx center");

		// Guillaume Cornut
		JLabel lblGuillaumeCornut = new JLabel("Guillaume Cornut");
		container.add(lblGuillaumeCornut, "cell 2 11,alignx center");

		// Developpers
		JLabel lblAuthors = new JLabel("Developpers:");
		lblAuthors.setFont(new Font("Lucida Grande", Font.BOLD, 12));
		container.add(lblAuthors, "cell 0 13 3 0,alignx center");
		
		// Julien Fleury
		JLabel lblJulienFleury = new JLabel("Julien Fleury");
		container.add(lblJulienFleury, "cell 0 14,alignx center");

		// Kévin Gravouil
		JLabel lblKvinGravouil = new JLabel("Kévin Gravouil");
		container.add(lblKvinGravouil, "cell 1 14,alignx center");
		
		// Armelle Kieffer
		JLabel lblArmelleKieffer = new JLabel("Armelle Kieffer");
		container.add(lblArmelleKieffer, "cell 2 14,alignx center");
		
		// Paper
		JLabel lblPaperTitle = new JLabel("Original workflow:");
		lblPaperTitle.setFont(new Font("Lucida Grande", Font.BOLD, 12));
		container.add(lblPaperTitle, "cell 0 16 3 0,alignx center");

		JLabel lblPaper = new JLabel("Echeverría, P. C. et al. (2011), PLoS ONE 6, e26044");
		container.add(lblPaper, "cell 0 17 3 1,alignx center");
		...
		container.add(lblOpenAccess, "cell 0 18 3 1,alignx center");
